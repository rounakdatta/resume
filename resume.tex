...
\begin{rSection}{Selected Projects}
  \textbullet\ \textbf{\textsf{smolgrad.ml}} [\textbf{\href{https://github.com/rounakdatta/smolgrad.ml}{\faicon{github}}}] - An educational implementation of automatic differentiation and neural networks in OCaml.

  \textbullet\ \textbf{\textsf{GoDFS}} [\textbf{\href{https://rounakdatta.github.io/posts/godfs}{\faicon{link}}}] [\textbf{\href{https://github.com/rounakdatta/GoDFS}{\faicon{github}}}] - Implementation of a toy distributed filesystem (inspired from GFS \& HDFS) in Go, with the aspects of hearbeat \& secondary namenode for fault tolerance.
