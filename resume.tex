...
\begin{rSection}{Experience}
  ...
  \begin{rSubsection}{\href{https://www.guvi.in/}{Guvi Geek Networks}}{Chennai, India}{Intern}{Mar `18 - Jul `18, Dec `18}
    ...
    \item Designed and developed an English \textbf{spelling \& grammatical corrector} using classical NLP methods; achieved around 73\% accuracy when benchmarked with Grammarly \& human proofreading. Released as OSS [\textbf{\href{https://github.com/rounakdatta/correctly}{\faicon{github}}}].
      \end{rSubsection}
